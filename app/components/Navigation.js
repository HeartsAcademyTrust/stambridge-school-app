				...
				<nav>
		        	...
		        	<ul className="collapsible" data-collapsible="accordion">
				          ...
				          <div className="collapsible-body">
				            <ul>
				              <li><a className="waves-effect waves-indigo" href="#">Curriculum</a></li>
					  					...
					  					<li><a className="waves-effect waves-indigo" href="#statuatory-info/">Statutory Information</a></li>
			          ...
			          <li>
				          ...
				          <div className="collapsible-body">
				            <ul>
				              <li><a className="waves-effect waves-indigo" href="#">Calender</a></li>
											<li><a className="waves-effect waves-indigo" href="#policies/">Letters Home</a></li>
											...
											<li><a className="waves-effect waves-indigo" href="#">School Menu</a></li>
				            </ul>
				          </div>
			          </li>		
		      		</ul>
		          ...
		          <li className="col-lg-2 col-xl-2 center-align no-pads">
			        ...
			        <li className="col-lg-2 col-xl-2 center-align no-pads waves-effect"><a href="#contact-us/">Contact Us</a></li>
	  				...
	  				<ul id="aboutDropdown" className="dropdown-content">
	  					...
	  					<li className="divider"></li>
	  					<li><a className="purple darken-4 white-text" href="#statuatory-info/">Statutory Information</a></li>
							<li className="divider"></li>
						...
						<ul id="parentsDropdown" className="dropdown-content">
	  					<li><a className="purple darken-4 white-text" href="#">Calender</a></li>
							<li className="divider"></li>
							<li><a className="purple darken-4 white-text" href="#policies/">Letters Home</a></li>
							<li className="divider"></li>
							...
							<li className="divider"></li>
							<li><a className="purple darken-4 white-text" href="#">School Menu</a></li>
						</ul>
					</div>
				</nav>
